...
version  <- "v013"  #cambiar cada vez, asi se tiene versionado del dataset
...
#leo TODOS los archivos que estan en   modelitos
...
fwrite( dataset,
        file=paste0( "./datasets/stacking_", version, ".csv.gz"),
        sep="," )